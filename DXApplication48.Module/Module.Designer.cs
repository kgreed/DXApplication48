namespace DXApplication48.Module {
	partial class DXApplication48Module {
		/// <summary> 
		...
		private void InitializeComponent() {
			// 
			// DXApplication48Module
			// 
			this.AdditionalExportedTypes.Add(typeof(DXApplication48.Module.BusinessObjects.ApplicationUser));
